...
# Create a list of all past sums and iterate through the list to find repeated sums snd repeat until found

def get_repeated_frequency(l):
    sum = 0
    partial_sums = []
    while True:
        ...
        for i in l:
            sum += int(i)
            if sum in partial_sums:
                return sum
            partial_sums.append(sum)
    return sum


# freq = add_str_list(freq_list)
# print(freq)
rep = get_repeated_frequency(freq_list)
print(rep)
